...
- Hold **Ctrl** and click markers on different lanes. The first click is the anchor; every further click stretches that lane so its marker lands on the anchor. Release Ctrl and repeat for the next group.
