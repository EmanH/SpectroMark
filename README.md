...
- **Batch sync**: Ctrl+drag a box over a stretch of several lanes. Inside the box, the first marker of every lane forms group 1, the second markers group 2, and so on. Each group is centred on its own, in time order, as a single undo step.
